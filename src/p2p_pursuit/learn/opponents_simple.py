"""Archetypes that navigate on geometry alone - no belief, no scent.

Split out of :mod:`.opponents` (§3.2). A random walker, a momentum runner,
a distance-gradient chaser/fleer and its barrier-spending variant, a
mobility-preserving holder and a camper. Deliberately weak; the point is
that they are *different* from each other and from us."""
